<template>
	<view class="datetime-picker">
		<view class="mask" :class="{ show: open }" @touchmove.stop.prevent catchtouchmove="true" @click="open = false"></view>
		<view class="wrap" :class="{ show: open }">
			...
			<view class="picker-body">
				<picker-view :value="value" @change="_onChange">
					<picker-view-column>
						<view class="column-item" v-for="(item, index) in years" :key="index">{{ item }}年</view>
					</picker-view-column>
					<picker-view-column>
						<view class="column-item" v-for="(item, index) in months" :key="index">{{ item | formatNum }}月</view>
					</picker-view-column>
					<picker-view-column>
						<view class="column-item" v-for="(item, index) in days" :key="index">{{ item | formatNum }}日</view>
					</picker-view-column>
					<picker-view-column>
						<view class="column-item" v-for="(item, index) in hours" :key="index">{{ item | formatNum }}时</view>
					</picker-view-column>
					<picker-view-column>
						<view class="column-item" v-for="(item, index) in minutes" :key="index">{{ item | formatNum }}分</view>
					</picker-view-column>
				</picker-view>
			</view>
		</view>
